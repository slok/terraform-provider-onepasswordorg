		...
		t.Run(name, func(t *testing.T) {
			...
			if test.expErr == nil {
				checks = resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.allow_viewing", fmt.Sprintf("%t", test.expVGA.Permissions.AllowViewing)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.allow_editing", fmt.Sprintf("%t", test.expVGA.Permissions.AllowEditing)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.allow_managing", fmt.Sprintf("%t", test.expVGA.Permissions.AllowManaging)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.view_items", fmt.Sprintf("%t", test.expVGA.Permissions.ViewItems)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.create_items", fmt.Sprintf("%t", test.expVGA.Permissions.CreateItems)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.edit_items", fmt.Sprintf("%t", test.expVGA.Permissions.EditItems)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.archive_items", fmt.Sprintf("%t", test.expVGA.Permissions.ArchiveItems)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.delete_items", fmt.Sprintf("%t", test.expVGA.Permissions.DeleteItems)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.view_and_copy_passwords", fmt.Sprintf("%t", test.expVGA.Permissions.ViewAndCopyPasswords)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.view_item_history", fmt.Sprintf("%t", test.expVGA.Permissions.ViewItemHistory)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.import_items", fmt.Sprintf("%t", test.expVGA.Permissions.ImportItems)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.export_items", fmt.Sprintf("%t", test.expVGA.Permissions.ExportItems)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.copy_and_share_items", fmt.Sprintf("%t", test.expVGA.Permissions.CopyAndShareItems)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.print_items", fmt.Sprintf("%t", test.expVGA.Permissions.PrintItems)),
					resource.TestCheckResourceAttr("onepasswordorg_vault_group_access.test", "permissions.0.manage_vault", fmt.Sprintf("%t", test.expVGA.Permissions.ManageVault)),
				)
			}
